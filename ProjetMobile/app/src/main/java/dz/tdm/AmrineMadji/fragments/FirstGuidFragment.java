...
public class FirstGuidFragment extends Fragment {
    public static final String ARG_PAGE = "ARG_PAGE";
    private int mPageNo;

    public FirstGuidFragment() {
        // Required empty public constructor
    }

    public static FirstGuidFragment newInstance(int pageNo) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, pageNo);
        FirstGuidFragment fragment = new FirstGuidFragment();
